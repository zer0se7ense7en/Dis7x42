byte charset[94][5] = {         // written in y-direction, 1 byte = 7y-coordinates
  {0,0,0,0,0},           // 
  {0,0,95,0,0},         // !
  {0,7,0,7,0},       // "
  {20,127,20,127,20},    // #
...
char InputString[] = {"    Willkommen im oLaF aka SFZ Osthessen        42 ist die Antwort auf alles        Willkommen im offenen Labor Fulda aka Sch<lerforschungszentrum Osthessen        This 7x42 Display was made by 077        "};
